...
```{r}
setwd("C:\\MPS\\projects\\TNB\\billing\\code\\wei_wern_working_file")
rm(list = ls())
```
...
#creating objects
#it can be the whole dataset, result of a calculation, a part of data set with specific traits
```{r}
...
data_sn_remark_servicereq_v3 <- 'BCRM Data/SN Remark Data/Service_Request_30June2019_For_NEW_SNREMARKS - 30Jun2019.xlsx'
...
```{r}
# WEI WERN COMMENT 1 JULY 2019
# should be no issue, can play around with the word boundary, since \\b only finds a match if there is a leading or trailing spaces
# e.g. bil tinggi.bacaan salah. - this case it will not be detected due to the lack of either leading or trailing whitespace
# e.g. bil tinggi. bacaan salah - this case the option \\bbacaan salah\\b will detect it
# e.g. bil tinggi.bacaan salah - this case the option bacaan salah\\b will detect it

customer_consumption_keywords <- "\\bMETER PEMBILAN OK\\b|\\bTIADA MASALAH PEMBILAN\\b|\\bDEPAT MENERIMA\\b|\\bKIRAN TEPAT\\b|\\bTEPAT\\b|\\bBETUL\\b|\\bMETER BETUL\\b|\\bSEMATAN BACCAN METER\\b|\\bTIADA KEROSAKAN\\b|\\bPENERANGAN\\b|\\bBERSETUJU\\b|\\bTUKAR ALAMAT\\b|\\bKAMPUNG\\b|\\bTAMAN\\b|\\bSTICKER KOYAK\\b|\\bMASALAH PENGGUNAAN\\b|\\bBACAAN ADALAH TEPAT\\b|\\bBACAAN ADALAH BENAR\\b|\\bBACAAN ADALH BENAR\\b|\\bBACAA N ADALAH BENAR\\b|\\bBACAAN ADALAH BETUL\\b|\\bPEMBACA METER BETUL\\b|\\bBACAAN TERATUR\\b|\\bBETUL DAN TEPAT\\b|\\bADALAH TEPAT\\b|\\bBACAAN TEPAT\\b|\\bACAAN BETUL\\b|\\bBACAAN METER BETUL\\b|\\bBAC AAN ADALAH BETUL\\b|\\bADALAH BETUL\\b|\\bREADING TEPAT\\b|\\bBA CAAN TERATUR\\b|\\bBENAR DAN TEPAT\\b|\\bBCN ADALAH BETU\\b|\\bADALAH BENAR\\b|\\bBACAAN YG BETUL\\b|\\bBACAAN BIL BULANAN BETUL\\b|\\bDIDAPATI BETUL\\b|\\bBACAAN YANG BENAR\\b|\\bBACAAN NORMAL\\b|\\b4 BUAH RUMAH GUNA SATU METER\\b|\\bTIADA MA SALAH PADA BACAAN\\b|\\bBACAAN DALAM KEADAAN TERATUR\\b|\\bTIADA MASALAH DALAM BACAAN\\b|\\bADALAH BE TUL DAN TEPAT\\b|\\bTAMBAHAN 1 AIR COND\\b|\\bBACAAN TIADA MASALAH\\b|\\bDAPATI BACA AN OK\\b|\\bTIADA MASALAH PADA BA CAAN METER\\b|\\bTIADA MASALAH PADA BACAAN METER\\b|\\bRDG OK\\b|\\bTIADA MASAALAH BACAAN\\b|\\bTIADA MASALAH PADA BACAAN ME TER\\b|\\bTIADA MASALAH PADA BACAAN\\b|\\bTIADA MASALAH PAD A BACAAN\\b|\\bPASANG COWAY\\b|\\bPENGGUNAAN ELEKTRI K TINGGI\\b|\\bADALAH BETU\\b|\\bSEMAKAN BACAAN ADALAH BE TUL\\b|\\bTIADA MASALA H DGN BACAAN\\b|\\bBACAAN A DALAH BETUL\\b|\\bBACAAN AFALAH BETUL DAN TERATUR\\b|\\bBILLING TERATUR\\b|\\bTIADA MASALAH BACAAN\\b|\\bTIADA MASALAH DALAM BAC\\b|\\bBACAAN YG BENAR\\b|\\bBACAAN METER ADALA BETUL\\b|\\bTIADA KESALAHAN BACAAN\\b|\\bBACAAN OLEH PEMBACA JAN GKA BETUL\\b|\\bBACAAN YANG SEBENAR DAN TEPAT\\b|\\bBACAAN AD ALAH BETUL\\b|\\bBACAAN OK\\b|\\bBACAAN ADA LAH BETU\\b|\\bPENGGUNAAN 22AMP3ECON\\b|\\bBACAAN DI METER BETUL\\b|\\bBACAAN YG DIAMBIL PEMBACA METER BETUL\\b|\\bDAPATI BACCAN BETUL\\b|\\bBACAAN DIPERMIS ADA BETUL\\b|\\bBACAAN YG DIBUAT BETUL\\b|\\bBACAAN ADALAH TERATUR\\b|\\bRDG BETUL\\b|\\bGUNAKAN PERKAKAS ELEKTRIK IAITU OVEN\\b|\\bGUNA PENGHAWA DINGIN 2HP PADA SIANG HARI\\b|\\bADA 4 A-CON\\b|\\b\\b|\\b31 HARI\\b|\\b31HARI\\b|\\bCHECK METER NORMAL\\b|\\bBILANGAN HARI >31HARI YANG MENYEBABKAN BIL TINGGI\\b|\\bKWH ADALAH BETUL\\b|\\bBACAAN ADALAH BETUL DAN TEPAT\\b|\\bBETUL TIADA MASALAH \\b|\\bTIADA KESALAHAN PADA BACAAN\\b|\\bBERSETUJU DENGAN PENJELASAN\\b|\\bTIADA PEMBETULAN BIL DI BUAT\\b|\\bSUDAH DISELARASKAN\\b|\\bOKRALAT\\b|\\bAIKRALAT\\b|\\bKEADAAN BAIK\\b|\\bJANGKA BAIK\\b|\\bBAIK\\b|\\bMETER OK\\b|\\bGOOD CONDITION\\b|\\bNORMALRALAT\\b|\\bTIDAK ROSAK\\b|\\bJANGKA OK\\b|\\bMTR OK\\b|\\bDISAHKAN TIADA MASAALAH\\b|\\bDALAM RALAT YANG DIBENARKAN\\b|\\bTIADA KEJANGGALAN METER\\b|\\bRALAT % ERROR TIDAK MELEBIHI JULAT\\b|\\bBAIKERROR\\b|\\bKEJITUAN\\b|\\bMETER DIUJI BAIK\\b|\\bCHECK METER NORMAL"

#TERATUR

meter_quality_keywords <- "\\bMETER AGEINGT\\b|\\bMETER SHORTING\\b|\\bTUKAR MTR\\b|\\bMETER RALAT\\b|\\bMETER MEKANIKAL\\b|\\bNO PAPARAN\\b|\\bMETER USANG\\b|\\bTIDAK MENYALA\\b|\\bBEKALAN MASIH ADA\\b|\\bMETER TERHENTI\\b|\\bCAJ MINIMA\\b|\\bMETER SAMAR\\b|\\bMETER BLANK\\b|\\bMETER BROKEN\\b|\\bMETER PICAH\\b|\\bGANTI METER\\b|\\bTIDAK BERGERAK\\b|\\
work_in_progress_keywords <- "\\bPREMIS TUTUP\\b|\\bTAK JAWAB\\b|\\bTIDAK BERJAWAB\\b|\\bKIV\\b|\\bTIADA DIPREMIS\\b|\\bKUNCI\\b|\\bBERKUNCI\\b|\\bPREMIS KOSONG\\b|\\bDITUNDA|\\bPANGGILAN TIDAK DIJAWAB|GATE LOCK|TIADA PENGGUNA|TIDAK DAPAT DI HUBUNGI|\\bTIDAK DAPAT DIHUBUNGI|SALAH BUAT ADUAN|SALAH REPORT|SALAH BUAT REPORT"

incorrect_reading_keywords <- "\\bSALAH\\b|\\bTIDAK TEPAT\\b|\\bBACAN SALAH\\b|\\bTIDAKTEPAT\\b|\\bWRONG KEY IN\\b|\\bTERSALAH AMBIL BACAAN\\b|\\bBACA AN SALAH\\b|\\bBACA SALAH\\b|\\bPEMBETULAN BACAAN\\b|\\bPEMBETULAN BA CAAN\\b|\\bBACAAN SALAH\\b|\\bRALAT BACAAN\\b|\\bBUAT BILL BARU\\b|\\bBACAAN SALA\\b|\\bKESILAPAN BACAAN\\b|\\b BACAAN\\b|\\bBETULKAN BACAAN\\b|\\bBACAAN SA LAH\\b|\\bBACAAN ADALAH SALAH\\b|\\bSALAH RDG\\b|\\bMETESALAHREDER SALAH\\b|\\bOVEREADING\\b|\\bSALAH MEMBUAT BACAAN\\b|\\bOVERREAD\\b|\\bBACAAN SUDAH DIBETULKAN\\b|\\bTERSALAH MENGAMBIL BACAAN\\b|\\bDIBETULKAN DENGAN BACAAN SEBENAR\\b|\\bBACCAN SUDAH DIBETULKAN\\b|\\bSALAH MMBUAT BACAAN\\b|\\bWRONG READING\\b|\\bBACAAN KVARH SALAH\\b|\\bBILL TELAH DIBETULKAN MENGIKUT BACAAN\\b|\\bOVER READ\\b|\\bADALAH SALAH\\b|\\bSALAH READING\\b|\\bRDG OVERRE AD\\b|\\bPEMBACA JANGKA TERSALAH\\b|\\bBACAAN METER SALAH\\b|\\bMR TERKURANG BACA\\b|\\bBACAAN MR BULAN 3 RENDAH\\b|\\bOVEREAD READING\\b|\\bTERSALAH BUAT BACAAN\\b|\\bKESALAHAN BACAAN\\b|\\bBACAAN UNDER READ\\b|\\bSALAH TECO READING\\b|\\bBIL TERSILAP BACA\\b|\\bBACAAN ADALAH KOSONG\\b|\\bBACAAN APRIL RENDAH\\b|\\bBACAAN DIBACA RENDAH\\b|\\bTERSALAH BACA\\b|\\bSALAH BACCAN\\b|\\bSILAP BACA\\b|\\bTERSALAH MASUKKAN BACAAN\\b|\\bBACAAN DAHULU SALAH\\b|\\bPEMBACA JANGKA BACA SALAH\\b|\\bYG TIDAK TEPAT\\b|\\bTIDAK TEPATPENGUNA\\b|\\bADALAH TIDAK TEPATPENGUNA\\b|\\bTIDAKTEPATPENGGUNA MEM\\b|\\bTIDAK TEPATMOHON\\b|\\bADALAH TIDAKTEPATPENGGUNA\\b|\\bTIDAK TEPAT PENJELASAN\\b|\\bTIDAK TEPATPENGGUNA\\b|\\bTIDAK TEPATPEMB ETULAN\\b|\\bBACAAN TIDAK BOLEHDIBETULKAN\\b|\\bBACAAN PEMBETULAN TIDAK\\b|\\bBACAAN BETULTIDAK\\b|\\bTIDAK BERAPA BETULPERGERAKAN\\b|\\bBACAAN BETULTIDAK DAPAT\\b|\\bUNDER READ"

missing_meter_keywords  <- "METER HILANG"

high_bill_keywords <- "\\b2 KALI GANDA\\b|\\bKALI GANDA\\b|\\bGANDA\\b|"

long_billing_period_keywords <- "\\bPRORATE\\b|\\bMELEBINI 30 HARI\\b|\\bLAMBAT\\b|\\bLAMBAT BACA\\b|\\b32 HARI\\b|\\b33 HARI\\b|\\b34 HARI\\b|\\b35 HARI\\b|\\b36 HARI\\b|\\bLEBIH 30 HARI\\b|\\b62 HARI\\b|\\bBIL DIBACA LAMBAT\\b|\\bPRORATA"

meter_healthy_keywords <- "\\bOKRALAT\\b|\\bAIKRALAT\\b|\\bKEADAAN BAIK\\b|\\bJANGKA BAIK\\b|\\bBAIK\\b|\\bMETER OK\\b|\\bGOOD CONDITION\\b|\\bNORMALRALAT\\b|\\bTIDAK ROSAK\\b|\\bJANGKA OK\\b|\\bMTR OK\\b|\\bDISAHKAN TIADA MASAALAH\\b|\\bDALAM RALAT YANG DIBENARKAN\\b|\\bTIADA KEJANGGALAN METER\\b|\\bRALAT % ERROR TIDAK MELEBIHI JULAT\\b|\\bBAIKERROR\\b|\\bKEJITUAN\\b|\\bMETER DIUJI BAIK\\b|\\bCHECK METER NORMAL"

smart_meter_keywords <- "\\bSMARTMETER\\b|\\bSMART\\b|\\bSMART METER\\b|\\bBILIK GERAKAN SM\\b|\\bUNIT SM\\b|\\bSM\\b|\\bMENGGUNAKANSMART METER\\b|\\bSMOC\\b|\\bSELEPAS TUKAR SMART METER"

system_error_keywords <- "\\bDEVICE ALLOCATION\\b"


estimate_bill_keywords <- "\\bBCAAN ANGARAN\\b|\\bBIL ANG GARAN\\b|\\bBACAAN EST\\b|\\bBILL N\\b|\\bBACAAN AGGARAN\\b|\\bBACAAN SEBENAR\\b|\\bE BILL\\b|\\bBIL E\\b|\\bBIL ANGGARAN\\b|\\bANGGARAN\\b|\\bBACAAN ESTIMATE\\b|\\bESTIMATE\\b|\\bSYSTEM EST RENDAH\\b|\\bBIL ANGGA RAN\\b|\\bBIL ELEKTRIK ESTI MATE\\b|\\bBIL ELEKTRIK ESTIMA TE"
#\\bBILL ANGGARAN BULAN\\b|
...
#write.csv(servicereq_SNremark_mart_23Jun2019_wflag, file = #"UPDATED_WITH23JUNSTATUS_INFO_SERVICEREQ_SNREMARK_ANALYSIS_24JUNE2019_run30June.csv")
...
```{r}
servicereq_SNremark_mart_23Jun2019_wflag %>% 
  write.xlsx(., "UPDATED_WITH30JUNSTATUS_INFO_SERVICEREQ_SNREMARK_ANALYSIS_30JUNE2019_run1July.xlsx")
```

```{r}
complaints_snremark_mart_23Jun2019_wflag_rca %>% 
  write.xlsx(., "UPDATED_WITH23JUNSTATUS_INFO_COMPLAINTS_RCA_SNREMARK_ANALYSIS_24JUNE2019.xlsx")
```
